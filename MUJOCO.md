# MuJoCo — быстрый старт для хакатона

> **Целевая аудитория:** вы никогда не открывали MuJoCo, у вас несколько часов, нужно понять, что происходит в коде и как это трогать.
